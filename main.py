...
photologo = 'https://sensitive-orange-2ndgmnoedd.edgeone.app/IMG_20250727_093946_936.jpg' #https://envs.sh/GV0.jpg
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton("💫 Get Access 🦅", url="tg://openmessage?user_id=8136984784")]
                    ])
                )
                return
            ...
            await m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📚 Help", url="tg://openmessage?user_id=8136984784")]])
            )
